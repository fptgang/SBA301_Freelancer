...
import {
  ProjectHeader
} from "../../../components/features/project/details/ProjectHeader";
import {
  ProjectDescription
} from "../../../components/features/project/details/ProjectDescription";
          ...
          {project && (
            <>
              ...
              <Descriptions bordered column={1} size="small">
                ...
                <Descriptions.Item
                  label="Category">{project.projectCategory?.name}</Descriptions.Item>
              </Descriptions>
              <br/>
            </>
          )}

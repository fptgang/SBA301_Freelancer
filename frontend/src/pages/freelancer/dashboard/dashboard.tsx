...
const FreelancerDashboardPage: React.FC = () => {
  ...
  const { data: projectData, isLoading: projectLoading } = useMany<ProjectDto>({
    resource: "projects",
    ids: projectIds.filter((id) => id !== undefined),
    queryOptions: {
  ...
  }, [proposalData, contractData, transactionData, projectData]);

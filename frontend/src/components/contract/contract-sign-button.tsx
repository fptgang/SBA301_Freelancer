...
import { Button, Modal, Checkbox, Alert, message, Form, Space, Card, Row, Col, Divider, Steps, Typography, Table } from "antd";
              ...
              <Alert
                ...
                description={
                  <ul className="list-disc pl-5 mt-2">
                    ...
                    <li>At any time, you can raise a dispute to the staff by clicking on "Report" button</li>
                  </ul>
                }
                type="success"
                showIcon
